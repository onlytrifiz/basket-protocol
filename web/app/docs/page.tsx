          ...
          <div className="docs-reference">
            ...
            <section className="docs-section" id="launch">
              ...
              <div className="docs-section-body">
                ...
                <div className="docs-callout"><p className="eyebrow">RELATED</p><h2>See the empty distribution ledger.</h2><p>Until the protocol is live, the dashboard intentionally shows no estimated APY or simulated payout history.</p><Link className="button button-ink" href="/dividends">Distribution desk <span>→</span></Link></div>
              </div>
            </section>
          </div>
        </section>
