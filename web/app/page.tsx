...
const mechanics = [
  ["01", "Trade STFY", "The ETH / STFY v4 market is designed to collect a 3% hook fee on trading."],
  ["02", "Acquire the index", "A keeper routes 90% of each collected hook fee into the active Base B20 equity index."],
  ["03", "Receive the stocks", "The dividend vault pushes each acquired asset pro-rata to eligible STFY holders."],
];
