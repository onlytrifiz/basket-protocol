...
/** Small in-process brake on outbound quoting. Use durable edge rate limiting in production. */
...
export async function readError(response: Response) {
  ...
  return payload?.detail || payload?.message || payload?.error || "The routing service could not build this route.";
}
