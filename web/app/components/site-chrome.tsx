...
type ActivePage = "overview" | "distributions" | "protocol";
  ...
  return (
    <footer className="site-footer">
      <div className="footer-inner">
        ...
        <div className="footer-links"><span>Explore</span><Link href="/distributions">Distributions</Link><Link href="/protocol">Protocol notes</Link><a href="https://base.org" target="_blank" rel="noreferrer">Built on Base ↗</a></div>
      </div>
